...
function isMemberInternal(jsDoc) {
...
class MarkdownMethods {
    ...
    toMarkdown() {
        const content = [];
        let rows = this.rows.filter(filterRow$1);
        if (rows.length === 0) {
            return content;
        }
...
class MarkdownProps {
    ...
    toMarkdown() {
        const content = [];
        let rows = this.rows.filter(filterRow$2);
        if (rows.length === 0) {
            return content;
        }
...
class PropRow {
    ...
    get attrName() {
        if (this.memberMeta.attribName) {
            ...
            if (propType === 4 /* Boolean */ || propType === 8 /* Number */ || propType === 2 /* String */) {
...
function generateReadme(config, compilerCtx, readmeOutputs, jsonDocs, moduleFile, dirPath) {
    return __awaiter(this, void 0, void 0, function* () {
...
function checkDocs(config, modules) {
        ...
        if (cmpMeta && !file.isCollectionDependency) {
            Object.keys(cmpMeta.membersMeta).forEach(memberName => {
                ...
                if (memberName[0] !== '_') {
                    ...
                    else if (member.memberType === 1 /* Prop */ || member.memberType === 2 /* PropMutable */) {
                        if (needsWarn(member.jsdoc)) {
...
function generateEsmHost(config, compilerCtx, cmpRegistry, outputTarget, sourceTarget) {
    return __awaiter(this, void 0, void 0, function* () {
        yield Promise.all([
...
function generateDefineCustomElements(config, compilerCtx, cmpRegistry, outputTarget, sourceTarget) {
    return __awaiter(this, void 0, void 0, function* () {
...
function generateEsm(config, compilerCtx, cmpRegistry, outputTarget, sourceTarget) {
    return __awaiter(this, void 0, void 0, function* () {
        const VAR = sourceTarget === 'es5' ? 'var' : 'const';
        const c = yield Promise.all(Object.keys(cmpRegistry).sort().map((tagName) => __awaiter(this, void 0, void 0, function* () {
            const cmpMeta = cmpRegistry[tagName];
...
function generateProxies(components, useDirectives) {
...
function generateProxy(cmpMeta, useDirectives) {
    ...
    if (!useDirectives) {
        directiveOpts.push(`changeDetection: ChangeDetectionStrategy.OnPush`, `encapsulation: ViewEncapsulation.None`, `template: '<ng-content></ng-content>'`);
    }
    if (inputs.length > 0) {
...
function minifyJs(config, compilerCtx, diagnostics, jsText, sourceTarget, preamble, buildTimestamp) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyJs', 'terser3.8.11', opts, jsText);
...
function optimizeCss(config, compilerCtx, diagnostics, styleText, filePath, legacyBuild) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cacheKey = compilerCtx.cache.createKey('optimizeCss', 'autoprefixer9.3.0_cssnano4.1.7_postcss7.0.5_1', opts);
        const cachedContent = yield compilerCtx.cache.get(cacheKey);
        if (cachedContent != null) {
...
function transpileToEs5Main(config, compilerCtx, input, inlineHelpers = true) {
    return __awaiter(this, void 0, void 0, function* () {
        const cacheKey = compilerCtx.cache.createKey('transpileToEs5', 'typescript2.9.21', input);
        const cachedContent = yield compilerCtx.cache.get(cacheKey);
        if (cachedContent != null) {
            const results = {
                code: cachedContent,
...
function loadDependentGlobalJsContents(config, compilerCtx, buildCtx, sourceTarget) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const dependentGlobalJsContents = yield Promise.all(collections.map((collectionManifest) => __awaiter(this, void 0, void 0, function* () {
...
function transpileCoreBuild(config, compilerCtx, coreBuild, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('transpileCoreBuild', 'typescript2.9.21', coreBuild, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
...
function minifyCore(config, compilerCtx, sourceTarget, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyCore', '181001225256', opts, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
                return {
...
function wrapCoreJs(config, jsContent, cmpRegistry) {
...
function replace(options = {}) {
    ...
    const keys = Object.keys(values).sort(longest).map(escape$1);
    const pattern = delimiters ?
        new RegExp(`${escape$1(delimiters[0])}(${keys.join('|')})${escape$1(delimiters[1])}`, 'g') :
...
function createBundle(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const rollupConfig = Object.assign({}, config.rollupConfig.inputOptions, { input: entryModules.map(b => b.filePath), experimentalCodeSplitting: true, preserveSymlinks: false, optimizeChunks: true, chunkGroupingSize: 5500, plugins: [
...
class Compiler {
    constructor(rawConfig) {
        ...
        if (this.isValid) {
            ...
            config.logger.debug(`compiler build: 181001225256`);
